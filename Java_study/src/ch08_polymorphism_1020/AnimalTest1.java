...
class Dog extends Animal {
	...
	public void sound() {
		System.out.println("강아지가 소리를 낸다.");
	}

	public void read() {
		System.out.println("강아지 책 봄.");
	}
}
...
public class AnimalTest1 {
	...
	public void eatFood(Animal animal) { // 매개 변수의 자료형이 상위 클래스
		animal.eat(); // 재정의 된 메서드 호출
	}

	public void animalSound(Animal animal) { // 매개 변수의 자료형이 상위 클래스
